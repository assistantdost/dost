				...
				<div className="grid grid-cols-1 md:grid-cols-12 gap-10 pb-12 border-b border-border">
					...
					<div className="md:col-span-5 space-y-4 text-left">
						...
						<p className="text-xs text-muted-foreground max-w-md leading-relaxed">
							DOST is an open-source personal agentic AI assistant framework implementing the standardized Model Context Protocol (MCP). Connect models to tools locally and safely.
						</p>
					</div>
					...
					<div className="md:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-8 text-left">
						<div className="space-y-3">
							...
							<ul className="space-y-2 text-xs">
								...
								<li><Link href="/mcp-servers" className="text-muted-foreground hover:text-foreground transition-colors">MCP Servers Explorer</Link></li>
							</ul>
						</div>
						<div className="space-y-3">
							<h4 className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Documentation</h4>
							<ul className="space-y-2 text-xs">
								<li><Link href="/docs" className="text-muted-foreground hover:text-foreground transition-colors">Documentation Home</Link></li>
								<li><Link href="/docs/setup-guide" className="text-muted-foreground hover:text-foreground transition-colors">Setup & Install Guide</Link></li>
								<li><Link href="/docs/adding-custom-mcp-servers" className="text-muted-foreground hover:text-foreground transition-colors">Custom MCP Servers</Link></li>
								<li><Link href="/docs/connecting-to-other-clients" className="text-muted-foreground hover:text-foreground transition-colors">Other MCP Clients</Link></li>
							</ul>
						</div>
